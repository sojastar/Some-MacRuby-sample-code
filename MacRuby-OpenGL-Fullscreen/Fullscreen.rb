class Fullscreen
	...
	def go_fullscreen
		...
		attributes[1]		= NSOpenGLPFAFullScreen			# Specify that we want a full-screen OpenGL context	
		attributes[2]		= NSOpenGLPFAScreenMask			# We may be on a multi-display system (and each screen may be driven by a different renderer) ...
		...
		@fullscreen_context	= NSOpenGLContext.alloc.initWithFormat(pixel_format, shareContext:@controller.opengl_view.openGLContext)
